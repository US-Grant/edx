...
def r_squared(y, estimated):
    ...
    """
    return 1 - sum([(yi - e)**2 for yi, e in zip(y, estimated)]) / sum([(yi - np.mean(y))**2 for yi in y])
...
def evaluate_models_on_training(x, y, models):
    ...
    print(best_r2)
    pylab.plot(x, y, "b.", label="real values",)
    pylab.plot(x, best_estimate, "r-", label="estimated values", )
    pylab.title("Climate data evaluation")
    pylab.xlabel("Year")
